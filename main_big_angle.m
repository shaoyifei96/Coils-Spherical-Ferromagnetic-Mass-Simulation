...
map_size= 0.4;%quiverdb plot has to have odd sized map size.
...
Coil2 = ElectroMagnet_Class(0,-I,N,L,R,Location2,Direction2);
...
%mass2=ferro_linear_mass(R_seph,mu2,m,Location4, Velocity4,sus);

R_seph=0.01;
m=0.002;%kg
Location4=[-0.03+0.02 0.015+0.02 0];
Velocity4=[0 0 0];
%mass3=ferro_linear_mass(R_seph,mu2,m,Location4, Velocity4,sus);
...
%[t, state]= Field1.simulate_mass(100,1,1);%when closing a animation when not done, output a error with invalid/deleted obj.
